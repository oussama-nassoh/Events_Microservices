    ...
    public function purchase(Request $request): JsonResponse
    {
        try {
            ...
            try {
                ...
                // Create tickets and payments in a transaction
                \DB::beginTransaction();
                ...
                for ($i = 0; $i < $request->quantity; $i++) {
                    ...
                    // Create individual payment for each ticket
                    $payment = new Payment([
                        'amount' => $event['price'],
                        'status' => 'completed',
                        'payment_method' => 'card',
                    ...
                    // Save the payment and associate it with the ticket
                ...
                try {
                    ...
                    foreach ($tickets as $ticket) {
                        ...
                        $notificationResponse = Http::post($notificationUrl, $notificationData);
